...
OP_INFO  op_info[] =
  {
    ...
    // Unary versions
    { "UMIN", 1, 6, NOBJ_VARTYPE_INT,     0, 0, "",     0,   MUTABLE_TYPE, 0, {NOBJ_VARTYPE_INT, NOBJ_VARTYPE_FLT, NOBJ_VARTYPE_FLT} },
    { "UNOT", 1, 1, NOBJ_VARTYPE_INT,     0, 1, "",     0, IMMUTABLE_TYPE, 0, {NOBJ_VARTYPE_INT, NOBJ_VARTYPE_FLT, NOBJ_VARTYPE_FLT} },
  };
